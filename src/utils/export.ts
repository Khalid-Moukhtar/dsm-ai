...
function toMarkdown(theme: Theme): string {
  ...
  return `> **For AI coding agents**: Apply the design tokens in this file consistently
> across all UI components in your project. Use these values as your single
> source of truth for colors, typography, spacing, and border radius.

---

# Design Rules: ${theme.name}
